                ...
                <Card style={{marginTop:15,margin:10}}>
                    ...
                    <View style={[{ flexDirection: "row" }]}>
                        <View style={{ flex: 2 ,left:40}} >
                            <Text style={[styles.cardTextStyle,{fontSize:17}]}>{moment(data.leave_form).format("DD/MM/YYYY")}</Text>
                        </View>
                        <View style={{ flex: 2,left:105}} >
                            <Text style={[styles.cardTextStyle,{fontSize:17}]}>{moment(data.leave_to).format("DD/MM/YYYY")}</Text>
                        </View>
                    ...
                    <View style={[{ flexDirection: "column",flex:1 }]}>
                        <View style={{ flex: 2,left:40,top:5 }} >
                            <Text style={[styles.cardTextStyle,{fontWeight:'bold'}]}>Leave reason:</Text>
                        </View>
                        <View style={{ flex: 2,left:40,top:5 }} >
                            <Text style={[styles.cardTextStyle,{color:'grey',fontSize:18}]}>{data.leave_reason}</Text>
                        </View>
                    </View>
                    </Card.Content>
                </Card>
