...
import { Avatar as NativeAvatar,Text as NativeText,Divider } from "native-base";
    ...
    <>
      <View style={[{flex:1}, {flexDirection: "column",backgroundColor:'white'}]}>
            ...
            <View style={{ flex: 1,backgroundColor:'#00008b'}} >
              <View style={[{flex:1}, {flexDirection: "row"}]}>
                <View style={{ flex: 1,alignItems:'center' }} >
                  <NativeText fontSize="16" style={{color:'white'}}>img_lights</NativeText>
                </View>
              </View>
        ...
        <View style={styles.cardStyle}>
          ...
          <View style={{ flex: 1.3}} >
            <View style={[{flex:1}, {flexDirection: "row",bottom:'12%'}]}>
              <View style={{ flex: 1}} >
          ...
          <View style={{ flex: 0.5}} >
            <View style={[{flex:1}, {flexDirection: "row",bottom:'16%'}]}>
              <View style={{ flex: 1}} >
                <NativeText fontWeight='bold'>Sutudent Standard:</NativeText>
              </View>
              <View style={{ flex: 1.6 }} >
          ...
          />
          <View style={[{flex:2}, {flexDirection: "row"}]}>
            <View style={{ flex: 1.9,alignItems:'center',marginVertical:25,marginHorizontal:1,left:'6%'}} >
