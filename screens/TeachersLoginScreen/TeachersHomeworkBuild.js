                ...
                <Card.Content>
                    ...
                    <View style={[{ flexDirection: "row" }]}>
                        <View style={{ flex: 2 ,left:40}} >
                            <Text style={[styles.cardTextStyle,{fontSize:17}]}>{moment(homeworkData.homework_date).format("DD/MM/YYYY")}</Text>
                        </View>
                        <View style={{ flex: 2,left:105}} >
                            <Text style={[styles.cardTextStyle,{fontSize:17}]}>{moment(homeworkData.due_date).format("DD/MM/YYYY")}</Text>
                        </View>
                    ...
                    <View style={[{ flexDirection: "column",flex:1 }]}>
                        <View style={{ flex: 2,left:40,top:5 }} >
                            <Text style={[styles.cardTextStyle,{fontWeight:'bold'}]}>Description:</Text>
                        </View>
                        <View style={{ flex: 2,left:40,top:5 }} >
                            <Text style={[styles.cardTextStyle,{color:'grey',fontSize:18}]}>{homeworkData.description}</Text>
                        </View>
                    </View>
                </Card.Content>
            </Card>
