                      ...
                      <Card style={{margin:10}}>
                          ...
                          <View style={[{ flexDirection: "row" }]}>
                              <View style={{ flex: 2 ,left:40}} >
                                  <Text style={[styles.cardTextStyle,{fontSize:15}]}>{moment(filteredData.startdate).format("DD/MM/YYYY")}</Text>
                              </View>
                              <View style={{ flex: 2,left:105}} >
                                  <Text style={[styles.cardTextStyle,{fontSize:15}]}>{moment(filteredData.enddate).format("DD/MM/YYYY")}</Text>
                              </View>
                          ...
                          <View style={[{ flexDirection: "column",flex:1 }]}>
                              ...
                              <View style={{ flex: 2,left:40,top:5 }} >
                                  <Text style={[styles.cardTextStyle,{color:'grey',fontSize:18}]}>{filteredData.description}</Text>
                              </View>
                          </View>
                          </Card.Content>
                      </Card>
