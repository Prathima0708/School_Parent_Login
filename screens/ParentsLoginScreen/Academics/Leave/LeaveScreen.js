...
const LeaveScreen = () => {
  ...
  function buttonPressedHandler() {
    ...
    //   return;
    // }
    if (!enteredSelcetdIsValid || !enteredLeaveReasonIsValid
      || !enteredFromDateIsValid || !enteredtoDateIsValid || !selected) {
      return;
    }
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    <Text style={styles.labelStyle}>Student Register number</Text>
                  </View>
                  <View style={{ flex: 1 }}>
                    <TextInput
                      style={[
