...
const Attendance = () => {
  const [forAttendanceList, setForAttendanceList] = useState({
    color: "black",
    fontWeight: "bold",
  });
  ...
  return (
    <>
      <View style={styles.BtnContainer}>
        <BgButton onPress={AttendanceList} style={forAttendanceList}>
          List
        </BgButton>
        <VerticalLine>|</VerticalLine>
        <BgButton onPress={addAttendance} style={forAddAttendance}>
          Add Attendance
        </BgButton>
      </View>
      {showTable && (
      ...
      {showForm && <ScrollView></ScrollView>}
    </>
  );
};
